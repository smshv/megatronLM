...
_FLOAT_TYPES = [torch.float32]#[get_accelerator().FloatTensor(0).dtype]
_HALF_TYPES = [torch.float16]#[get_accelerator().HalfTensor(0).dtype]
_BF16_TYPES = [torch.bfloat16]#[get_accelerator().BFloat16Tensor(0).dtype]
