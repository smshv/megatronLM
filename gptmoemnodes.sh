...
run_cmd="deepspeed --num_nodes ${NUM_NODE} --num_gpus ${NUM_GPUS} pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options}"

cmd="jsrun -smpiargs=-disable_gpu_hooks -n $nnodes -r 1 -g 2 -a 2 -c 42 python3 -m deepspeed.launcher.launch --node_rank="